...
public class TableCellRendererTest {
    ...
    Object[][] tableData = {
            ...
            new Object[]{"李清照",29,"女",new ImageIcon(PathUtils.getRealPath("11\\3.gif")),true},
            new Object[]{"苏格拉底",56,"男",new ImageIcon(PathUtils.getRealPath("11\\1.gif")),false},
            new Object[]{"李白",35,"男",new ImageIcon(PathUtils.getRealPath("11\\4.gif")),true},
            new Object[]{"弄玉",18,"女",new ImageIcon(PathUtils.getRealPath("11\\2.gif")),true},
            new Object[]{"虎头",2,"男",new ImageIcon(PathUtils.getRealPath("11\\5.gif")),false},
    ...
    class GenderTableCellRenderer extends JPanel implements TableCellRenderer {
        ...
        public void paint(Graphics g) {
            ...
            if (cellValue.equals("男") || cellValue.equals("male")){
                drawImage(g,new ImageIcon(PathUtils.getRealPath("11\\male.gif")).getImage());
            }

            //如果表格的内容为nv或female，则绘制一个女性图标
            if (cellValue.equals("女") || cellValue.equals("female")){
                drawImage(g,new ImageIcon(PathUtils.getRealPath("11\\female.gif")).getImage());
            }
        }
